...
use Cdlr\codeBundle\Entity\Admin;
use Cdlr\codeBundle\Form\AdminType;
...
class AdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CdlrcodeBundle:Admin')->findAll();

        return $this->render('CdlrcodeBundle:Admin:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CdlrcodeBundle:Admin:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CdlrcodeBundle:Admin')->find($id);
        ...
        return $this->render('CdlrcodeBundle:Admin:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CdlrcodeBundle:Admin:edit.html.twig', array(
            'entity'      => $entity,
