...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['blade_tester_calendar.calendar'] = new \BladeTester\CalendarBundle\Model\Calendar($this->get('doctrine.orm.default_entity_manager'), $this->get('debug.event_dispatcher'), 'Cdlr\\CalendarBundle\\Entity\\Event');
    }
    ...
    {
        return $this->services['blade_tester_calendar.forms.event'] = new \BladeTester\CalendarBundle\Form\Type\EventFormType('Cdlr\\CalendarBundle\\Entity\\Event');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Cdlr\UserBundle\Form\Type\RegistrationFormType A Cdlr\UserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getCdlrUser_Registration_Form_TypeService()
    {
        return $this->services['cdlr_user.registration.form.type'] = new \Cdlr\UserBundle\Form\Type\RegistrationFormType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'halfman_code_de_la_route', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_45dcbe1d72553a2b9de278d3e774d99ad1d5f57a82d731e30db3c74e6c871a5c');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Cdlr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating.engine.twig'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('noreply@Cdlr.com' => 'noreply'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Cdlr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'cdlr_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Cdlr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Cdlr\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Cdlr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['happyr.google.api.client'] = new \HappyR\Google\ApiBundle\Services\GoogleClient(array('application_name' => 'Cdlr', 'oauth2_client_id' => '1053473949173-t58kfk5acbm4fcucr1kvs77pb1eaeaj6.apps.googleusercontent.com', 'oauth2_client_secret' => 'SMV4CiK9R1zwx0_322Ge5sun', 'oauth2_redirect_uri' => 'https://cdlr.site90.com/oauth2callback', 'developer_key' => 'AI39si5nSy34uW56P57eknfcwjdj1_pCmTpUvi0mh5xwa461ami0nFMp_W5Qd4QS8RKNql17AV_Kov6F5210o53vc9NC41H-Lg', 'site_name' => 'cdlr.site90.com'));
    }
    ...
    {
        return $this->services['nomaya.socialbarhelper'] = new \Nomaya\SocialBundle\Helpers\SocialBarHelper($this->get('templating.engine.twig'));
    }
    ...
    {
        return $this->services['nomaya.sociallinkshelper'] = new \Nomaya\SocialBundle\Helpers\SocialLinksHelper($this->get('templating.engine.twig'));
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Cdlr\UserBundle\Redirection\AfterLoginRedirection A Cdlr\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \Cdlr\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home/admin/');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home/candidat/');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home/gerant/');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/home/moniteur/');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/secured/.*');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/login_check');
        ...
        $q->add($k, array(0 => 'ROLE_CANDIDAT'), NULL);
        $q->add($l, array(0 => 'ROLE_GERANT'), NULL);
        $q->add($m, array(0 => 'ROLE_MONITEUR'), NULL);
        ...
        $s = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $r, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($r, '/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    protected function getTemplating_Engine_TwigService()
    {
        ...
        return $this->services['templating.engine.twig'] = new \Elao\WebProfilerExtraBundle\TwigProfilerEngine($a, new \Symfony\Bundle\TwigBundle\Debug\TimedTwigEngine($a, $this->get('templating.name_parser'), $this->get('templating.locator'), $this->get('debug.stopwatch')), $this->get('web_profiler_extra.data_collector.twig'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Elao\\WebProfilerExtraBundle/Resources/views'), 'WebProfilerExtra');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_CANDIDAT' => array(0 => 'ROLE_CANDIDAT'), 'ROLE_GERANT' => array(0 => 'ROLE_GERANT'), 'ROLE_MONITEUR' => array(0 => 'ROLE_MONITEUR'), 'ROLE_ADMIN' => array(0 => 'ROLE_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_user.model.user.class' => 'Cdlr\\UserBundle\\Entity\\User',
