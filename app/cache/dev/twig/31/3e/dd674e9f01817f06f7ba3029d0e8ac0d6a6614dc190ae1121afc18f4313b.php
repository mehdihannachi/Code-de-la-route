...
/* CdlrcodeBundle:Gerant:show.html.twig */
class __TwigTemplate_313edd674e9f01817f06f7ba3029d0e8ac0d6a6614dc190ae1121afc18f4313b extends Twig_Template
{
    ...
    <div class=\"container\">
        <div class=\"sixteen columns\">
            <!-- Headline -->
            <h3 class=\"margin-reset\">Gérant</h3><br />
            ...
            <div align=\"center\">
                <ul>
                    <li>
                        <a href=\"";
        // line 45
        echo $this->env->getExtension('routing')->getPath("gerant");
        echo "\" class=\"button color\">retour</a>&nbsp;
                        <a href=\"";
        // line 46
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("gerant_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
...
";
    ...
    {
        return "CdlrcodeBundle:Gerant:show.html.twig";
    }
