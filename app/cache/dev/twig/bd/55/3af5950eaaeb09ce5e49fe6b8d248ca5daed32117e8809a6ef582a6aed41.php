...
/* CdlrcodeBundle:Notification:index.html.twig */
class __TwigTemplate_bd553af5950eaaeb09ce5e49fe6b8d248ca5daed32117e8809a6ef582a6aed41 extends Twig_Template
{
    ...
    <table class=\"records_list\" border=\"1\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "</td>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, $this->getAttribute($context["entity"], "idDestination", array()), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($context["entity"], "typeDestination", array()), "html", null, true);
            echo "</td>
                <td>
                <ul>
                    <li>
    ...
    {
        return "CdlrcodeBundle:Notification:index.html.twig";
    }
