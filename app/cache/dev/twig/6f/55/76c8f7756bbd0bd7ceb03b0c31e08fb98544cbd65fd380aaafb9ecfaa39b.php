...
/* CdlrcodeBundle:Candidat:index.html.twig */
class __TwigTemplate_6f5576c8f7756bbd0bd7ceb03b0c31e08fb98544cbd65fd380aaafb9ecfaa39b extends Twig_Template
{
    ...
    <div class=\"container\">
        <div class=\"sixteen columns\">
            <!-- Headline -->
            <h3 class=\"margin-reset\">Liste des candidats</h3><br />
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entity"]) {
            ...
            echo "                        <tr>
                            <td><a href=\"";
            // line 27
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("candidat_show", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">";
            ...
            echo "\">show</a>
                                    ...
                                    <li>
                                        <a href=\"";
            // line 41
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("candidat_edit", array("id" => $this->getAttribute($context["entity"], "id", array()))), "html", null, true);
            echo "\">edit</a>
                                    </li>
                                </ul>
                            </td>
            ...
            <div align=\"center\">
                <ul>
                    <li>
                        <a href=\"";
        // line 53
        echo $this->env->getExtension('routing')->getPath("candidat_new");
        echo "\" class=\"button color\">Ajouter candidat</a>
                        </a>
                    </li>
                </ul>
            </div>       
...
";
    ...
    {
        return "CdlrcodeBundle:Candidat:index.html.twig";
    }
