 ...
 */
class Cours extends \Cdlr\codeBundle\Entity\Cours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Cdlr\\codeBundle\\Entity\\Cours' . "\0" . 'nom', '' . "\0" . 'Cdlr\\codeBundle\\Entity\\Cours' . "\0" . 'categorie', '' . "\0" . 'Cdlr\\codeBundle\\Entity\\Cours' . "\0" . 'url', '' . "\0" . 'Cdlr\\codeBundle\\Entity\\Cours' . "\0" . 'coursId');
        }
    ...
    public function getCoursId()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getCoursId();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoursId', array());
