...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['blade_tester_calendar.calendar'] = new \BladeTester\CalendarBundle\Model\Calendar($this->get('doctrine.orm.default_entity_manager'), $this->get('event_dispatcher'), 'Cdlr\\CalendarBundle\\Entity\\Event');
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'halfman_code_de_la_route', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a0184d944540d8834c25980ceeed5d67fdaecd48ee61ef960bd75dcdec9cc4d2');
        return $instance;
    }
